...
const destinationEgype2 = {
  ...
  tourItinerary: [
    ...
    },
    {
      ...
      description:
        'Morning after your breakfast we will pick you up from the cruise going to visit the High Dam, followed by a tour to Philae Temple on an Island dedicated to Goddess Isis, after the tour will return to the cruise.',
      image: '/images/tours/cairo-city-tour.jpg',
    },
    {
      day: 'Day 5',
...
const EgyptTripTwo = () => {
  const subtitleText = clip(
    `Egyptian art is also a mixture of styles from other cultures—the Egyptians borrowed techniques from the Etruscans and Greeks, for instance; they used materials like wood or stone; they made art for various purposes such as religious rituals or tomb decoration.`,
    150
  );
  return (
    <>
      <Heading
        title={`Egypt: 5 Days, 4 nights Luxury Trip`}
        imageSrc={'/images/cards/egypt6.jpg '}
