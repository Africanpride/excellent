...
function Destinations() {
  ...
  const tourOverviewEgyptYoga = clip('We are very thrilled to introduce 11 days / 10 nights of Yoga Retreats - Sahara Adventurein Egypt. This is a feature packed trip to  excite and thrill you for 11 days and 10 nights.', 120);
...
<section className="text-gray-800 dark:text-gray-400 bg-gray-200 dark:bg-gray-900 body-font">
        <div className="container md:px-5 md:py-5 mx-auto">
          ...
          <Link href="/tours/togo-ghana-adventure-and-culinary-trip">
            <a className="p-2 md:p-2 lg:w-1/4">

            <div className="h-full shadow  bg-gray-200  dark:bg-gray-800 dark:bg-opacity-40 px-5 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <Link href="/tours/togo-ghana-adventure-and-culinary-trip">
            ...
            <div className="h-full shadow  bg-gray-200  dark:bg-gray-800 dark:bg-opacity-40 px-5 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
             {/* Add  background image  */}
              <img className="absolute w-full h-full object-cover object-center inset-0 z-0" 
              src="/images/cards/egypt-yoga1.jpg" alt="Egypt Tour: Yoga Retreats – Sahara Adventure (11 Days /10 Nights)" />
              <div className="absolute inset-0 bg-blue-900 dark:opacity-50 opacity-40 "></div>
                <h2 className="relative z-10 tracking-widest text-xs title-font font-medium text-yellow-300 mb-1">AFRICA TOURS</h2>
                <h1 className="relative z-10 title-font sm:text-2xl text-xl font-medium text-white dark:text-white  mb-3">Egypt Tour: Yoga Retreats  <br />– Sahara Adventure</h1>
                <p className="relative z-10 leading-relaxed mb-3 dark:text-white text-submarine-300 "> {tourOverviewEgyptYoga} </p>
